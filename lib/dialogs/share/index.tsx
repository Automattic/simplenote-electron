...
export class ShareDialog extends Component<Props> {
  ...
  render() {
    const { closeDialog, note, themeClass } = this.props;
          ...
          <TabPanels tabNames={shareTabs}>
            <div>
              <div className="settings-group">
                <p>
                  Add an email address of another Simplenote user to share a
                  note. You&apos;ll both be able to edit and view the note.
                </p>
            ...
            <div>
              <div className="settings-group">
                ...
                <p>
                  Ready to share your note with the world? Anyone with the
                  public link will be able to view the latest version.
                </p>
              </div>
              {isPublished && (
                <div className="settings-group">
