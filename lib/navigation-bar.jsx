		...
		return (
			<div className="navigation color-bg color-fg color-border">
				<div className="navigation-folders">
					<button type="button" className="navigation-folders-item button button-text color-fg" onClick={this.props.onSelectAllNotes}>
						<span className="navigation-icon"><NotesIcon /></span>
						All Notes
					</button>
					<button type="button" className="navigation-folders-item button button-text color-fg" onClick={this.props.onSelectTrash}>
				...
				<div className="navigation-tools color-border">
					<button type="button" className="navigation-tools-item button button-text color-fg" onClick={this.props.onSettings}>
						<span className="navigation-icon"><NotesIcon /></span>
						Settings
					</button>
				</div>
