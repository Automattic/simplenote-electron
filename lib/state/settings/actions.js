...
export const setSourceListWidth = ( width ) => ( {
	type: 'setSourceListWidth', width
} );

export const setSourceListResizing = ( isResizing = true ) => ( {
	type: 'setSourceListResizing', isResizing
} );

export const setSourceListCanResize = ( canResize = true ) => ( {
	type: 'setSourceListCanResize', canResize
} );
