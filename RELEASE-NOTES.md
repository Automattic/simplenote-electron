...
- Updated the note toolbar and note info sidebar to be two dialogs, one for note info, and one for note actions [#2622](https://github.com/automattic/simplenote-electron/pull/2622)
...
- Fixed cut off issue for dialogs when the window is too small [#2815](https://github.com/automattic/simplenote-electron/pull/2815)
